...
colors:
  ...
  text-muted: "#9AA1AB"
  text-light: "#6B7280"
  accent-light: "rgba(240, 180, 41, 0.08)"
  accent-medium: "rgba(240, 180, 41, 0.15)"
  border: "rgba(240, 180, 41, 0.2)"
  card-bg: "rgba(240, 180, 41, 0.04)"
  positive: "#2F9E6F"
  negative: "#D9534F"
...
typography:
  ...
  tag:     { fontFamily: "-apple-system", px: 12, weight: 600, color: "primary" }
  counter: { fontFamily: "-apple-system", px: 13, weight: 600, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (-apple-system, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "-apple-system", cqw: 1.25, weight: 600, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "-apple-system", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "-apple-system", cqw: 2.4, weight: 600, lineHeight: 1.35, color: "text" }
...
- **Weights** — the brand font ships `{400, 600, 650, 700}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
